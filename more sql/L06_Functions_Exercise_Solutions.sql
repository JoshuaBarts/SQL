...
SELECT department_id, TO_CHAR(AVG(salary), '$999,990.00') as "AVG Salary" 
FROM employees INNER JOIN departments
USING(department_id)
group by department_id
order by 1;

SELECT d.department_id, TO_CHAR(AVG(e.salary), '$999,990.00') as "AVG Salary" 
...
(as SQL99 implementing USING statement).
************************************************************************/

SELECT department_id, d.department_name, TO_CHAR(AVG(salary), '$999,990.00') as "AVG Salary" 
...
SQL99 - Implement with ON statement
************************************************************************/

SELECT job_title as "Job", MIN(salary) AS "Min", MAX(salary) AS "Max", AVG(salary) as "Average"
...
SELECT last_name, TO_CHAR(hire_date, 'YYYY-Mon-DD') as "Hire Date",
